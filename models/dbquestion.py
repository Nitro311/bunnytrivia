...
def _import_questions():
    ...
    q = DbQuestion(index=21, theme="Religion/Mythology", question="What was the world's principal Christian city before it fell to the Ottoman Turks in 1453?", answer="Constantinople", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Rome", is_approved=True).put(); DbAnswer(question=q, text="Rome", is_approved=True).put(); DbAnswer(question=q, text="Rome", is_approved=True).put(); DbAnswer(question=q, text="Rome", is_approved=True).put()
    ...
    q = DbQuestion(index=24, theme="Religion/Mythology", question="What biblical epic was the top-grossing movie of the 1950's?", answer="Ten Commandments", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put()
