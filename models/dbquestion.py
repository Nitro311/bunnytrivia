...
def _import_questions():
    ...
    q = DbQuestion(index=265, theme="Miscellaneous", question="How many points did the Seahawks score in super bowl 48?", answer="43", shows=None, likes=None); q.put(); DbAnswer(question=q, text="7", is_approved=True).put();  DbAnswer(question=q, text="51", is_approved=True).put();  DbAnswer(question=q, text="48", is_approved=True).put();
    q = DbQuestion(index=266, theme="Miscellaneous", question="What dog breed was the dog voted ugliest dog in the us", answer="Muggly", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Poodle", is_approved=True).put();  DbAnswer(question=q, text="Pug", is_approved=True).put();  DbAnswer(question=q, text="Bulldog", is_approved=True).put();
    q = DbQuestion(index=267, theme="Miscellaneous", question="What was the name of the human \"elf\" in the movie Elf?", answer="Buddy", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Will", is_approved=True).put();  DbAnswer(question=q, text="James", is_approved=True).put();  DbAnswer(question=q, text="John", is_approved=True).put();  DbAnswer(question=q, text="Junior", is_approved=True).put();  DbAnswer(question=q, text="Fred", is_approved=True).put();
    q = DbQuestion(index=268, theme="Miscellaneous", question="What is the name of the cat in the keyboard cat meme?", answer="Fatso", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Black & White", is_approved=True).put();  DbAnswer(question=q, text="Playa", is_approved=True).put();  DbAnswer(question=q, text="Keys", is_approved=True).put();  DbAnswer(question=q, text="Beethoven", is_approved=True).put();
    q = DbQuestion(index=269, theme="Miscellaneous", question="What is the name of the success kid in the success kid meme?", answer="Sammy", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Fred", is_approved=True).put();  DbAnswer(question=q, text="Joe", is_approved=True).put();  DbAnswer(question=q, text="he legally changed it to Success Kid", is_approved=True).put();  DbAnswer(question=q, text="Bob", is_approved=True).put();