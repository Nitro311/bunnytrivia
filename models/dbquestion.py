...
def _import_questions():
    ...
    q = DbQuestion(index=8, theme="Religion/Mythology", question="What follows mass as the most popular activity in U.S. Catholic churches?", answer="Bingo", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Brunch", is_approved=True).put(); DbAnswer(question=q, text="Brunch", is_approved=True).put(); DbAnswer(question=q, text="Youth Group", is_approved=True).put(); DbAnswer(question=q, text="Youth Group", is_approved=True).put()
    q = DbQuestion(index=9, theme="Religion/Mythology", question="What Arab nation has the highest percentage of Christians?", answer="Lebanon", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Saudi Arabia", is_approved=True).put(); DbAnswer(question=q, text="Saudi Arabia", is_approved=True).put(); DbAnswer(question=q, text="Syria", is_approved=True).put(); DbAnswer(question=q, text="Syria", is_approved=True).put()
    q = DbQuestion(index=10, theme="Religion/Mythology", question="What symbol did St. Patrick use to explain his theory of the Holy Trinity?", answer="Shamrock", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Cross", is_approved=True).put(); DbAnswer(question=q, text="Cross", is_approved=True).put(); DbAnswer(question=q, text="Fish", is_approved=True).put(); DbAnswer(question=q, text="Fish", is_approved=True).put()
    q = DbQuestion(index=11, theme="Religion/Mythology", question="What country boasts the largest number of Catholics?", answer="Brazil", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Italy", is_approved=True).put(); DbAnswer(question=q, text="Italy", is_approved=True).put(); DbAnswer(question=q, text="United States", is_approved=True).put(); DbAnswer(question=q, text="United States", is_approved=True).put()
    q = DbQuestion(index=12, theme="Religion/Mythology", question="What name has been shared by the most popes?", answer="John", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Francis", is_approved=True).put(); DbAnswer(question=q, text="Francis", is_approved=True).put(); DbAnswer(question=q, text="Henry", is_approved=True).put(); DbAnswer(question=q, text="Henry", is_approved=True).put()
    q = DbQuestion(index=13, theme="Religion/Mythology", question="Which other wicked city besides Gomorrah was destroyed by God in Genesis?", answer="Sodom", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Corinth", is_approved=True).put(); DbAnswer(question=q, text="Corinth", is_approved=True).put(); DbAnswer(question=q, text="Jeruselum", is_approved=True).put(); DbAnswer(question=q, text="Jeruselum", is_approved=True).put()
    q = DbQuestion(index=14, theme="Religion/Mythology", question="What two European countries claim two-thirds of the world's 2,000-plus registered saints?", answer="Italy and France", shows=None, likes=None); q.put(); DbAnswer(question=q, text="England and France", is_approved=True).put(); DbAnswer(question=q, text="England and France", is_approved=True).put()
    q = DbQuestion(index=15, theme="Religion/Mythology", question="What fruit is depicted in Leonardo's Last Supper, even though it did not arrive in the Holy Land until long after Jesus' death?", answer="Orange", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Fig", is_approved=True).put(); DbAnswer(question=q, text="Fig", is_approved=True).put(); DbAnswer(question=q, text="Lemon", is_approved=True).put(); DbAnswer(question=q, text="Lemon", is_approved=True).put(); DbAnswer(question=q, text="Lime", is_approved=True).put(); DbAnswer(question=q, text="Lime", is_approved=True).put()
    ...
    q = DbQuestion(index=17, theme="Religion/Mythology", question="What Saudi Arabian city was the birthplace of the prophet Muhammad?", answer="Mecca", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Babylon", is_approved=True).put(); DbAnswer(question=q, text="Babylon", is_approved=True).put(); DbAnswer(question=q, text="Baghdad", is_approved=True).put(); DbAnswer(question=q, text="Baghdad", is_approved=True).put()
    q = DbQuestion(index=18, theme="Religion/Mythology", question="What storied city on the Euphrates River was 55 miles south of Baghdad?", answer="Babylon", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Jeruselum", is_approved=True).put(); DbAnswer(question=q, text="Jeruselum", is_approved=True).put(); DbAnswer(question=q, text="Mecca", is_approved=True).put(); DbAnswer(question=q, text="Mecca", is_approved=True).put()
    q = DbQuestion(index=19, theme="Religion/Mythology", question="What biblical place name means \"pleasure\"?", answer="Eden", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Babylon", is_approved=True).put(); DbAnswer(question=q, text="Babylon", is_approved=True).put(); DbAnswer(question=q, text="Solomon's temple", is_approved=True).put(); DbAnswer(question=q, text="Solomon's temple", is_approved=True).put()
    q = DbQuestion(index=20, theme="Religion/Mythology", question="What city did Napoleon occupy in 1798, sending Pope Pius VI to the south of France?", answer="Rome", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Tripoli", is_approved=True).put(); DbAnswer(question=q, text="Tripoli", is_approved=True).put(); DbAnswer(question=q, text="Venice", is_approved=True).put(); DbAnswer(question=q, text="Venice", is_approved=True).put()
    q = DbQuestion(index=21, theme="Religion/Mythology", question="What was the world's principal Christian city before it fell to the Ottoman Turks in 1453?", answer="Constantinople", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Rome", is_approved=True).put(); DbAnswer(question=q, text="Rome", is_approved=True).put()
    q = DbQuestion(index=22, theme="Religion/Mythology", question="What nation's Catholics saw the Pope make a triumphant homecoming visit in 1980?", answer="Poland", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Hungary", is_approved=True).put(); DbAnswer(question=q, text="Hungary", is_approved=True).put(); DbAnswer(question=q, text="Romania", is_approved=True).put(); DbAnswer(question=q, text="Romania", is_approved=True).put()
    ...
    q = DbQuestion(index=24, theme="Religion/Mythology", question="What biblical epic was the top-grossing movie of the 1950's?", answer="Ten Commandments", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put(); DbAnswer(question=q, text="Ben Hur", is_approved=True).put()
    q = DbQuestion(index=25, theme="Religion/Mythology", question="Who was the first pope? St. ______", answer="Peter", shows=None, likes=None); q.put(); DbAnswer(question=q, text="James", is_approved=True).put(); DbAnswer(question=q, text="James", is_approved=True).put(); DbAnswer(question=q, text="Patrick", is_approved=True).put(); DbAnswer(question=q, text="Patrick", is_approved=True).put()
    q = DbQuestion(index=26, theme="Religion/Mythology", question="How many 'days and nights' did Jonah spend in the belly of the whale?", answer="Three", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Five", is_approved=True).put(); DbAnswer(question=q, text="Five", is_approved=True).put(); DbAnswer(question=q, text="Seven", is_approved=True).put(); DbAnswer(question=q, text="Seven", is_approved=True).put()
    ...
    q = DbQuestion(index=28, theme="Religion/Mythology", question="What language is Jesus believed to have spoken?", answer="Aramaic", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Greek", is_approved=True).put(); DbAnswer(question=q, text="Greek", is_approved=True).put(); DbAnswer(question=q, text="Hebrew", is_approved=True).put(); DbAnswer(question=q, text="Hebrew", is_approved=True).put()
    ...
    q = DbQuestion(index=38, theme="Food", question="How many flowers are in the design stamped on each side of an Oreo cookie?", answer="12", shows=None, likes=None); q.put(); DbAnswer(question=q, text="1", is_approved=True).put(); DbAnswer(question=q, text="4", is_approved=True).put(); DbAnswer(question=q, text="8", is_approved=True).put()
    q = DbQuestion(index=39, theme="Food", question="Black-eyed peas are not peas. What are they?", answer="Beans", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Flowers", is_approved=True).put(); DbAnswer(question=q, text="Gourds", is_approved=True).put(); DbAnswer(question=q, text="Lettuce", is_approved=True).put()
    q = DbQuestion(index=40, theme="Food", question="Under what name did the Domino's Pizza chain get its start?", answer="DomNick's", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Checkers", is_approved=True).put(); DbAnswer(question=q, text="Gamers", is_approved=True).put(); DbAnswer(question=q, text="Red and White", is_approved=True).put()
    q = DbQuestion(index=41, theme="Food", question="What was margarine called when it was first marketed in England?", answer="Butterine", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Better", is_approved=True).put(); DbAnswer(question=q, text="Butter oil", is_approved=True).put(); DbAnswer(question=q, text="Dobutter", is_approved=True).put()
    q = DbQuestion(index=42, theme="Food", question="What are the two top selling spices in the world? ______ and mustard", answer="Pepper", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Garlic", is_approved=True).put(); DbAnswer(question=q, text="Ketchup", is_approved=True).put(); DbAnswer(question=q, text="Salt", is_approved=True).put()
    q = DbQuestion(index=43, theme="Food", question="What was the name of Cheerios when it was first marketed 50 years ago?", answer="Cheerioats", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Circles of oats", is_approved=True).put(); DbAnswer(question=q, text="O", is_approved=True).put(); DbAnswer(question=q, text="Oaties", is_approved=True).put()
    q = DbQuestion(index=44, theme="Food", question="What flavor of ice cream did Baskin-Robbins introduce to commemorate America's landing on the moon on July 20, 1969?  Lunar _______", answer="Cheesecake", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Cookie dough", is_approved=True).put(); DbAnswer(question=q, text="Fudge", is_approved=True).put(); DbAnswer(question=q, text="Mint", is_approved=True).put()
    q = DbQuestion(index=45, theme="Food", question="What is the most widely eaten fish in the world?", answer="Herring", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Salmon", is_approved=True).put(); DbAnswer(question=q, text="Trout", is_approved=True).put(); DbAnswer(question=q, text="Tuna", is_approved=True).put()
    ...
    q = DbQuestion(index=47, theme="Food", question="The milk of which animal is used to make authentic Italian mozzarella cheese?", answer="water buffalo", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Cow", is_approved=True).put(); DbAnswer(question=q, text="Goat", is_approved=True).put(); DbAnswer(question=q, text="Sheep", is_approved=True).put()
    q = DbQuestion(index=48, theme="Food", question="What nation produces two thirds of the world's vanilla?", answer="Madagascar", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Brazil", is_approved=True).put(); DbAnswer(question=q, text="Egypt", is_approved=True).put(); DbAnswer(question=q, text="India", is_approved=True).put()
    ...
    q = DbQuestion(index=52, theme="Food", question="What American city produces most of the egg rolls sold in grocery stores in the United States?", answer="Houston", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Kansas City", is_approved=True).put(); DbAnswer(question=q, text="San Fransisco", is_approved=True).put()
    q = DbQuestion(index=53, theme="Food", question="What was the first of H.J. Heinz' \"57 varieties\"?", answer="Horseradish", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Ketchup", is_approved=True).put(); DbAnswer(question=q, text="Mustard", is_approved=True).put(); DbAnswer(question=q, text="Pickle", is_approved=True).put()
    q = DbQuestion(index=54, theme="Food", question="What is the literal meaning of the Italian word linguine?", answer="Little tongues", shows=None, likes=None); q.put(); DbAnswer(question=q, text="Eel", is_approved=True).put(); DbAnswer(question=q, text="Little ropes", is_approved=True).put(); DbAnswer(question=q, text="Long hair", is_approved=True).put()
    ...
    q = DbQuestion(index=270, theme="Miscellaneous", question="What is a dust or sandstorm commonly occurring in Africa or India called?", answer="Haboob", shows=None, likes=None); q.put()
    q = DbQuestion(index=271, theme="Miscellaneous", question="Jiminez de Quesada, 16th century explorer, who discovered the ______ and introduced it to Europe", answer="Potato", shows=None, likes=None); q.put()
    q = DbQuestion(index=272, theme="Miscellaneous", question="Lucy Pearson has one of the world's largest collections of _______", answer="Hubcabs", shows=None, likes=None); q.put()
    q = DbQuestion(index=273, theme="Miscellaneous", question="Gyles Brandreth, a British man, rewrote the classic play ________ without using the letter 'I' anywhere", answer="Hamlet", shows=None, likes=None); q.put()
    q = DbQuestion(index=274, theme="Miscellaneous", question="S.I.T.U. stands for Society for the Investigation of the __________", answer="Unexplained", shows=None, likes=None); q.put()
    q = DbQuestion(index=275, theme="Miscellaneous", question="James Naismith, gym teacher, who invented the game of _______", answer="Basketball", shows=None, likes=None); q.put()
    q = DbQuestion(index=276, theme="Miscellaneous", question="George Dawes invented spring-loaded _________?", answer="Chopsticks", shows=None, likes=None); q.put()
    q = DbQuestion(index=277, theme="Miscellaneous", question="F.T.E. is the Florida ______ Exchange", answer="Tomato", shows=None, likes=None); q.put()
    q = DbQuestion(index=278, theme="Miscellaneous", question="What is the mating sound of a peacock called?", answer="Frantling", shows=None, likes=None); q.put()
    q = DbQuestion(index=279, theme="Miscellaneous", question="What is the name of a drum roll?", answer="Paradiddle", shows=None, likes=None); q.put()
    q = DbQuestion(index=280, theme="Miscellaneous", question="S.I.C. stands for Society of ________ Collectors", answer="Inkwell", shows=None, likes=None); q.put()
    q = DbQuestion(index=281, theme="Miscellaneous", question="What is a fish that can see above and below the water simultaneously?", answer="Anableps", shows=None, likes=None); q.put()
    q = DbQuestion(index=282, theme="Miscellaneous", question="T.C.I. is _______ Collectors International", answer="Thimble", shows=None, likes=None); q.put()
    q = DbQuestion(index=283, theme="Miscellaneous", question="U.F.P. stands for United Federation of _______", answer="Planets", shows=None, likes=None); q.put()
